(ns matsurigoto.methods.test-lexicons
  ...
  Proves the structural invariants are encoded identically in all THREE places —
    (1) the schema EDN  contracts/schemas/egov-execution-ontology.kotoba.edn
    (2) the lexicons    wire/lexicons/*.json
...
#?(:clj
   (defn- onto []
     (edn/load-edn (io/file repo "contracts" "schemas" "egov-execution-ontology.kotoba.edn"))))
